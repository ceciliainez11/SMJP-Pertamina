...
namespace SMJP.MasterDataServices.API.Migrations
{
    ...
    [Migration("20240606031358_AddUsersToDb")]
            ...
            modelBuilder.Entity("SMJP.MasterDataServices.API.Models.Companies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8066),
                            Latitude = "40.7128",
                            LogoUrl = "https://pertamina.com/logo1.png",
                            Longitude = "-74.0060",
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8071),
                            ProvinceID = 1
                        });
                });
            ...
            modelBuilder.Entity("SMJP.MasterDataServices.API.Models.Regions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyID = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8298),
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8303),
            ...
            modelBuilder.Entity("SMJP.MasterDataServices.API.Models.Schedules", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyID = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 6, 6, 10, 13, 57, 173, DateTimeKind.Local).AddTicks(8451),
                            Date = new DateTime(2024, 6, 6, 10, 13, 57, 173, DateTimeKind.Local).AddTicks(8432),
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2024, 6, 6, 10, 13, 57, 173, DateTimeKind.Local).AddTicks(8453),
                            RegionID = 1,
                            ShiftID = 1,
                            SiteID = 1
                        });
            ...
            modelBuilder.Entity("SMJP.MasterDataServices.API.Models.Shifts", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ShiftID = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8660),
                            EndAt = new DateTime(2024, 6, 6, 16, 0, 0, 0, DateTimeKind.Unspecified),
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8662),
            ...
            modelBuilder.Entity("SMJP.MasterDataServices.API.Models.Sites", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyID = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8366),
                            ModifiedBy = 1,
                            ModifiedDate = new DateTime(2024, 6, 6, 3, 13, 57, 173, DateTimeKind.Utc).AddTicks(8368),
                            RegionID = 1,
